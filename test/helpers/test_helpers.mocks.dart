...
// in real_estate/test/helpers/test_helpers.dart.
...
import 'package:real_estate/data_models/location.dart' as _i2;
import 'package:real_estate/services/map_box_service.dart' as _i8;
...
///
/// See the documentation for Mockito's code generation for more information.
class MockMapBoxService extends _i1.Mock implements _i8.MapBoxService {
  @override
  _i2.Location get current => (super.noSuchMethod(
  ...
  @override
  set current(_i2.Location? _current) => super.noSuchMethod(
        Invocation.setter(
          #current,
          _current,
        ),
